...
public interface SolicitacaoRepository extends JpaRepository<Solicitacao, Long> {
    ...
    @Query("SELECT s.id AS id, s.produto.nome AS nomeProduto, s.status AS status, " +
            ...
            "FROM Solicitacao s")
    Page<SolicitacaoListProjection> findAllPageableSolicitacoes(Pageable pageable);
    ...
    Page<SolicitacaoFornecedorProjection> findAllPageableSolicitacoesByFornecedor(Pageable pageable, @Param("fornecedor") Fornecedor fornecedor);
